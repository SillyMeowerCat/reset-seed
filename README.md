...
## How it works
Basically, it simulates a player completing the following actions: Pressing escape to open up settings, pressing leave game, then pressing play. Pretty simple
